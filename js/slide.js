(function($){
	...
	function scrollPage(element){
		...
		wordTransform(iIndex);
	}

	function wordTransform(i){
		$("p, span", arrElement[iIndex]).each(function(i){
			var x = Math.random()*50-25;
			var oldAngle = this.rotatedAngle;
			this.style.transform = "rotate("+x+"deg)";
			this.style.transition = "all 3000ms ease";
			this.rotatedAngle = this.rotatedAngle?this.rotatedAngle+x:x;
			console.log(oldAngle, x, this.rotatedAngle);
...
$(function(){
	...
	$("#correct").click(function(){
		$("p").each(function(){
			this.style.transform = "rotate(-"+this.rotatedAngle+"deg)";
			this.style.transition = "all 3000ms ease";
		})
	})
});